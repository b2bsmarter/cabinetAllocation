...
<section class="content paddingleft_right15">
    <div class="row">
        ...
        <div class="card panel-primary ">
            ...
            <form class="form-horizontal" action="{{ route('offsiteBackup.update', $backup->id) }}" method="post">
            {{ method_field('post') }}
            {{ csrf_field() }}
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="type" name="type" class="form-control" type="text" placeholder="Type" value="{{ $backup->type }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="customer" name="customer" class="form-control" type="text" placeholder="Customer" value="{{ $backup->customer }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="username" name="username" class="form-control" type="text" placeholder="Username" value="{{ $backup->username }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="ashay_backup_type" name="ashay_backup_type" class="form-control" type="text" placeholder="ASHAY Backup Type" value="{{ $backup->ashay_backup_type }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="password" name="password" class="form-control" type="text" placeholder="Password" value="{{ $backup->password }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="master_key_encryption" name="master_key_encryption" class="form-control" type="text" placeholder="Master Key Encryption" value="{{ $backup->master_key_encryption }}">
                        </div>
                    </div>
                </div>
