...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('cabinet.adminAccount') }}"> Cabinet Allocation - Admin Accounts</a></li>
...
<section class="content paddingleft_right15">
    <div class="row">
        ...
        <div class="card panel-primary ">
            ...
            <form class="form-horizontal" action="{{ route('adminAccount.store') }}" method="post">
            {{ method_field('post') }}
            {{ csrf_field() }}
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="account_name" name="account_name" class="form-control" type="text" placeholder="Account Name">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="description" name="description" class="form-control" type="text" placeholder="Deccription">
                        </div>
                    </div>
                </div>
