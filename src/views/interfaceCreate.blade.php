...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('cabinet.interface') }}"> Cabinet Allocation - Interfaces</a></li>
                    <li class="active">Create Interface</li>
                </ol>
</section>
        ...
        <div class="card panel-primary ">
            <div class="card-heading cardBackground">
                <h4 class="card-title float-left"> <i class="livicon" data-name="file-import" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                    Create Offsite Interface
                </h4>
            </div>
            <div class="card-body">

            <form class="form-horizontal" action="{{ route('interface.store') }}" method="post">
            {{ method_field('post') }}
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="short_code" name="short_code" class="form-control" type="text" placeholder="Short Code">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="vlan" name="vlan" class="form-control" type="text" placeholder="VLAN">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="interface" name="interface" class="form-control" type="text" placeholder="Interface">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="subnet" name="subnet" class="form-control" type="text" placeholder="Subnet">
                        </div>
                    </div>
                </div>
