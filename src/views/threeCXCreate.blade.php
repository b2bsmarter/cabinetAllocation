...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('cabinet.threeCX') }}"> Cabinet Allocation - 3CXs</a></li>
                    <li class="active">Create 3CX</li>
                </ol>
</section>
...
<section class="content paddingleft_right15">
    <div class="row">
        ...
        <div class="card panel-primary ">
            ...
            <form class="form-horizontal" action="{{ route('threeCX.store') }}" method="post">
            {{ method_field('post') }}
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="server_name" name="server_name" class="form-control" type="text" placeholder="Server Name">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="ip_address" name="ip_address" class="form-control" type="text" placeholder="IP Address">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="hdd" name="hdd" class="form-control" type="text" placeholder="HDD">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="call_recording" name="call_recording" class="form-control" type="text" placeholder="Call Recording">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="fqdn" name="fqdn" class="form-control" type="text" placeholder="FQDN">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="management_port" name="management_port" class="form-control" type="text" placeholder="Management Port">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="licence_key_type" name="licence_key_type" class="form-control" type="text" placeholder="Licence Key Type">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="licence_key" name="licence_key" class="form-control" type="text" placeholder="Licence Key">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="email_address" name="email_address" class="form-control" type="text" placeholder="Email Address">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="customer_portal_username" name="customer_portal_username" class="form-control" type="text" placeholder="Customer Portal Username">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="customer_portal_password" name="customer_portal_password" class="form-control" type="text" placeholder="Customer Portal Password">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="root_username" name="root_username" class="form-control" type="text" placeholder="Root Username">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="root_password" name="root_password" class="form-control" type="text" placeholder="Root Password">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="threecx_login" name="threecx_login" class="form-control" type="text" placeholder="3CX Login">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="threecx_password" name="threecx_password" class="form-control" type="text" placeholder="3CX Password">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input id="sip_provider" name="sip_provider" class="form-control" type="text" placeholder="SIP Provider">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="offset-sm-5 col-sm-9">
                        <button type="submit" class="btn btn-primary">Create 3CX</button>
                    </div>
                </div>
